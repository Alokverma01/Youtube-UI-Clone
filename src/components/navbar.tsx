...
const Navbar = () => {
  ...
  if (!context) {
    throw new Error("Navbar must be used inside AppProvider");
  }
  ...
  return (
    <nav>
      <div className="flex text-white justify-between mx-auto h-14 items-center">
        {/* 
        {isSidebarOpen ? <Sidebar /> : ""} */}
        {/* LOGO */}
        <div className="flex gap-6 items-center">
          <Bars3Icon
            className="size-6 cursor-pointer ml-7"
            onClick={toggleSidebar}
          />
          <svg
            xmlns="http://www.w3.org/2000/svg"
            id="yt-ringo2-svg_yt50"
            width="93"
            height="20"
            viewBox="0 0 93 20"
            focusable="false"
            aria-hidden="true"
            className="pointer-events: none; display: inherit; width: 100%; height: 100% text-white"
          >
            <g>
              <path
        ...
        {/* SEARCH BAR*/}
        <div className="flex items-center justify-between gap-4 w-[40vw] ml-10">
          <div className="border border-neutral-600 w-full rounded-full flex items-center justify-between">
            <input
              type="text"
              placeholder="Search"
              className="text-white px-5 py-2 outline-none"
            />
            <div className="w-14 pr-10 bg-neutral-800 h-10 rounded-r-full relative">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
                stroke-width="2"
                stroke="currentColor"
                className="size-6 absolute top-2 right-4"
              >
                <path
          ...
          <div className="rounded-full h-10 w-11 bg-neutral-800 flex justify-center items-center">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
        ...
        {/* PROFILE ICON */}
        <div className="flex justify-between pr-10 gap-3">
          {/* CREATE BUTTON */}
          <div className="flex bg-neutral-800 px-4 py-2 rounded-full gap-2 text-[15px]">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
          ...
          <div className="flex justify-center items-center">
            ...
            <div
              className="w-5 h-5 bg-red-500 text-xs flex
             justify-center items-center rounded-full px-1 py-1 absolute top-2 right-24"
            >
              9+
            </div>
          </div>
          {/* PROFILE ICON */}
          <div className="w-9 h-9 bg-neutral-700 rounded-full ml-3 text-center pt-1.5 text-green-200">{`A`}</div>
        </div>
      </div>
    </nav>
  );
